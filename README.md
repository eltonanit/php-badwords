...
1) Stampare a schermo il suo paragrafo e la sua lunghezza - metodo echo lunghezza:strlen
2) per cambiare la parola str replace
3) 
step
faccio la form
creo fil e welcome
recupero i dati in get li stampo
vado a manipolare la stringa
ristampo i dati 
